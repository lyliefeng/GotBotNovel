...
1. 创建一个公开仓库，默认地址为 `gitee.com/lv-liefeng/GotBotNovel`。
...
- 截至 2026 年 7 月 17 日，公开仓库 `gitee.com/lv-liefeng/GotBotNovel` 已存在，
  但还没有 Gitee Release；在配置 `GITEE_ACCESS_TOKEN` 并发布带更新清单和分片的
  Release 前，代码和安装包可以构建，但无法完成真实的在线更新验证。
