...
╚═══════════════════════════════════════════════════════════════╝
    ...
    print("\n请输入要创建的数据库信息:\n")
    db_name = input("数据库名 [gotbotnovel]: ").strip() or "gotbotnovel"
    db_user = input("数据库用户名 [gotbot]: ").strip() or "gotbot"
    db_password = getpass("数据库用户密码 [gotbot123]: ") or "gotbot123"
